    ...
    return (
        <React.Fragment>
            <div className="mt-[60px] flex items-center justify-start">
                ...
                <div className="ml-[129px] w-full">
                    <h2 className="text-[36px] leading-[30px] font-inter font-medium">
                        Create an account
                    </h2>
                    ...
                    >
                        <div className="scale-95">
                            ...
                            >
                                <g clip-path="url(#clip0_829_3336)">
                                    <path
                    ...
                    <p className="mt-4 text-center">
                        ...
                        <Link
                            to={'/login'}
                            className="underline underline-offset-4 font-medium opacity-80 hover:opacity-100 transition duration-200"
                        >
                            Log in
                        </Link>
                    </p>
