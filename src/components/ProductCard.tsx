        ...
        <React.Fragment>
            <div>
                <div className="group relative h-[250px] rounded-sm bg-neutral-200 flex items-start justify-center select-none">
                    <div className="absolute w-[55px] h-[26px] rounded-sm top-[12px] left-[12px] bg-[#db4444]">
                ...
                <div className="mt-4">
                    ...
                    {!product.salePrice && (
                        <p className="text-base font-medium text-[#db4444] mb-2">
                            ${product.price}
                        </p>
                    )}
                    {product.salePrice && (
